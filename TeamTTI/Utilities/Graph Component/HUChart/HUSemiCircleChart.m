...
- (void)drawText:(NSString *) text
    ...
    if (text.length > 0) {
        ...
        if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_1) {
            ...
            UILabel *textFrame = [[UILabel alloc] init];
            ...
            [[NSMutableAttributedString alloc] initWithString:text1 attributes:@{
                                                                                 ...
                                                                                 NSForegroundColorAttributeName : [UIColor colorWithRed:74/255.0 green:84/255.0 blue:86/255.0 alpha:1.0]
                                                                                 }];
            ...
            UIFont *text2Font = [UIFont fontWithName:@"Avenir-Medium" size:36];
            NSMutableAttributedString *attributedString2 =
            [[NSMutableAttributedString alloc] initWithString:text2 attributes:@{NSFontAttributeName : text2Font,
                                                                                 NSForegroundColorAttributeName : [UIColor colorNamed:@"tti_blue"] }];
            ...
            // 107/156 text
            UIFont *text3Font = [UIFont fontWithName:@"Avenir-Medium" size:17];
            NSMutableAttributedString *attributedString3 =
            [[NSMutableAttributedString alloc] initWithString:text3 attributes:@{NSFontAttributeName : text3Font,
                                                                                 NSForegroundColorAttributeName : [UIColor colorWithRed:136/255.0 green:140/255.0 blue:144/255.0 alpha:1.0]
                                                                                 }];
            ...
            [textFrame.attributedText drawInRect:textRect];
